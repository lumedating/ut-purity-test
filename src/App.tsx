...
const PROMO_COPY: Record<
  ScoreTier,
  {
    control: { before: string; link: string };
    test: { before: string; link: string };
  }
> = {
...
const QUESTIONS = [
  ...
  "Driven to Texas State (San Marcos) to hook up?",
...
function App() {
  ...
  async function copyLink() {
    try {
      await navigator.clipboard.writeText("https://qr.link/8jHSCO");
      setLinkCopied(true);
      window.setTimeout(() => setLinkCopied(false), 2000);
    } catch {
      // Clipboard failed — stay quiet.
    }
  }
  ...
  return (
    <main className="page">
            ...
            <div className="results-actions">
              ...
              >
                {linkCopied ? (
                  ...
                  >
                    <path
                      d="M10 13a5 5 0 0 0 7.54.54l1.92-1.92a5 5 0 0 0-7.07-7.07L11.17 6"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M14 11a5 5 0 0 0-7.54-.54L4.54 12.38a5 5 0 0 0 7.07 7.07L13 18.07"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
      ...
      {showResults && promo && (
        <div className="lume-promo">
          <p className="lume-promo-text">
            {promo.before}
            <a
          ...
          <div className="lume-promo-brand">
            <img className="lume-promo-logo" src={lumeLogo} alt="Lume" />
            <span className="lume-promo-divider" aria-hidden="true" />
            <p className="lume-promo-tagline">
              win real dates,
              <br />
              UT students only
            </p>
